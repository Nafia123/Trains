...
/*
        ...
        System.out.println(secondTrain);
*/
        Locomotive locomotive = new Locomotive(3123,23);
        Locomotive locomotive1 = new Locomotive(123123, 123);
        Train train = new Train(locomotive,"Amsterdam", "Haarlem");
        Train train1 = new Train(locomotive1,"Haarlem", "Amsterdam");
        PassengerWagon wagon = new PassengerWagon(123,123);
        train.setFirstWagon(wagon);
        Shunter.moveAllFromTrain(train,train1,wagon);
